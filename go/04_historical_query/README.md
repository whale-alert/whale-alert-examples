# 04. Historical Query (Block Range)
...
```bash
go run main.go -blockchain ethereum -start 20000000 -end 20000100 -min-usd 250000 -limit 100
```
...
```bash
go run main.go -blockchain bitcoin -blocks 500 -min-usd 500000
```
...
```text
Initializing Historical Query for blockchain: ethereum
Querying block height range: #20,590,001 to #20,590,100 (100 blocks) [Threshold: >= $100,000 USD]
Fetching page 1...
Processing page 1 (42 transactions received, blocks #20,590,001 to #20,590,067)...
Fetching page 2...
Processing page 2 (18 transactions received, blocks #20,590,068 to #20,590,100)...
Fetching page 3...
Page 3 returned 0 transactions. Historical scan complete.
